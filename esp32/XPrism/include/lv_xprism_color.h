...
#define LV_COLOR_PINK lv_color_hex(0xffc0cb)
#define LV_COLOR_BROWN lv_color_hex(0xa52a2a)
#define LV_COLOR_SILVER lv_color_hex(0xc0c0c0)
#define LV_COLOR_GOLD lv_color_hex(0xffd700)
...
#define LV_COLOR_INDIGO lv_color_hex(0x4b0082)
#define LV_COLOR_VIOLET lv_color_hex(0xee82ee)
#define LV_COLOR_AQUA lv_color_hex(0x00ffff)
#define LV_COLOR_MAGENTA lv_color_hex(0xff00ff)
#define LV_COLOR_DARKGRAY lv_color_hex(0xa9a9a9)
#define LV_COLOR_LIGHTGRAY lv_color_hex(0xd3d3d3)
