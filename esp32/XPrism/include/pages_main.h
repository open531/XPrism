...
#define LED_CONFIG_PATH "/led.cfg"
...
{
public:
	XPages(const char *name = XPAGES_NAME);
	~XPages();
	void init(void);
	...
	void read_config(LEDConfig *cfg);
	void write_config(LEDConfig *cfg);
