...
extern const char *imu_active_type_info[];

enum IMU_ACTIVE_TYPE
{
    TURN_RIGHT = 0,
    RETURN,
    TURN_LEFT,
...
struct ImuAction
{
    volatile IMU_ACTIVE_TYPE active;
    boolean isValid;
    boolean long_time;
...
public:
    ...
    // 用来储存历史动作
    // std::list<IMU_ACTIVE_TYPE> act_info_history;
    IMU_ACTIVE_TYPE act_info_history[ACTION_HISTORY_BUF_LEN];
